<template>
  <header>
    ...
    <span id="avatar">
      <img src="https://i.pravatar.cc/500" alt="avatar" loading="lazy" />
      <h5 id="notifications">+29</h5>
    </span>
  </header>
</template>
...
$primary-background: linear-gradient(to bottom, rgba(8,40,57,1) 30%, rgba(70,90,104,1) 100%);
header {
